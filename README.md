...
2. Open the project in NetBeans or any IDE of your choice (the following instructions will most likely only work on NetBeans as i haven't tested it on other IDEs but they should be similar).
